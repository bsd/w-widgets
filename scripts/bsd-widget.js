(function (global) {
  ...
  if (window.jQuery === undefined || window.jQuery.fn.jquery !== '2.2.4') {
    ...
    script_tag.setAttribute("src", "http://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js");
