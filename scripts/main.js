        ...
        fetchFields: function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    const customArr = arr.filter(function (ar) {
                        return ar.is_custom_field === '1'; // if falsy then assign to another array
                    });
                    ...
                    arr = arr.filter(function (ar) {
                        return ar.is_custom_field === '0'; // if truthy then keep item
                    });
